    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.h_rect = rg.Rectangle(rg.Point(self.intersection_center.x - 0.5*width
                                            ,self.intersection_center.y -0.5*letter_thickness),
                                   rg.Point(self.intersection_center.x + 0.5*width
                                            ,self.intersection_center.y +0.5*letter_thickness))
        self.v_rect = rg.Rectangle(rg.Point(self.intersection_center.x - 0.5*self.letter_thickness
                                            ,self.intersection_center.y - 0.5*self.letter_thickness),
                                   rg.Point(self.intersection_center.x + 0.5*self.letter_thickness
                                            ,self.intersection_center.y + height - 0.5*letter_thickness))
        # self.fill = ' '
        # self.out = ' '
    ...
    def move_by(self, dx, dy):
        ...
        # ---------------------------------------------------------------------
        # self.h_rect = rg.Rectangle(rg.Point(
        #     self.h_rect.corner_1.x + dx,self.h_rect.corner_1.y + dy
        # ),rg.Point(
        #     self.h_rect.corner_2.x + dx, self.h_rect.corner_2.y + dy
        # ))
        #
        # self.v_rect = rg.Rectangle(rg.Point(
        #     self.v_rect.corner_1.x + dx, self.v_rect.corner_1.y + dy
        # ),rg.Point(
        #     self.v_rect.corner_2.x + dx, self.v_rect.corner_2.y + dy
        # ))
    ...
    def clone(self):
        ...
        #######################################################################
        ca =CapitalT(self.intersection_center,self.width,self.height,self.letter_thickness)
        ca.h_rect.fill_color = self.h_rect.fill_color
        ca.h_rect.outline_color = self.h_rect.outline_color
        ca.v_rect.fill_color = self.v_rect.fill_color
        ca.v_rect.outline_color = self.v_rect.outline_color
        return ca
